...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.nameLabel setText:group.channelId];
    [cell.whoLabel setText:group.channelTitle];
    [cell.locationLabel setText:[NSString stringWithFormat:@"%@, %@", group.channelId, group.channelId]];
    [cell.descriptionLabel setText:group.channelId];
